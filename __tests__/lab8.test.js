const { pipelineBareFunction, pipelineTopicExpression } = require("@babel/types");
...
describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    // console.log(button);
    let startingText = await button.getProperty("innerText");
    let innerText = startingText["_remoteObject"].value;
    await button.click();
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    // starting from 1 to skip the clicked element in step 2
    ...
    let numProducts = cartCount["_remoteObject"].value;
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (let i = 0; i < prodItems.length; i++) {
      ...
      let buttonText = innerText["_remoteObject"].value;
